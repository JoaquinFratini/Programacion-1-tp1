...
export class lvl3 extends Phaser.Scene {
    ...
    preload() {
      this.load.tilemapTiledJSON("map", "public/assets/tilemaps/mapaLvl3.json");
      this.load.image("tilesBelow", "public/assets/images/atlasN3.png");
      this.load.image("tilesPlatform", "public/assets/images/atlasN3.png");
      this.load.image("bombona", "public/assets/images/bombona.png")
    }
    ...
    create() {
      ...
      const tilesetBelow = map.addTilesetImage("atlasN3", "tilesBelow");
      ...
      objectsLayer.objects.forEach((objData) => {
        ...
        switch (name) {
          case "bombona": {
            ...
            var star = stars.create(x, y, "bombona");
    ...
    update() {
      if (stars.countActive(true) === 0) { 
        this.scene.start("lvl2", { score: score });
      }
      if (gameOver) {
        return;
      }
