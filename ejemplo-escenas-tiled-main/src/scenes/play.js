...
export class Play extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image("tilesBelow", "public/assets/images/mapaN1.png");
    this.load.image("tilesPlatform", "public/assets/images/mapaN1.png");
  ...
  create() {
    ...
    const tilesetBelow = map.addTilesetImage("mapaN1", "tilesBelow");
  ...
  update() {
    if (stars.countActive(true) === 0) { 
      this.scene.start("lvl3", { score: score });
    }
    if (gameOver) {
      return;
    }
