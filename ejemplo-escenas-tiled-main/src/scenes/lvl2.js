...
var star2;
 export class lvl2 extends Phaser.Scene {
    ...
    preload() {
        this.load.tilemapTiledJSON("map", "public/assets/tilemaps/mapaLvl4.json");
        this.load.image("tilesBelow", "/public/assets/images/atlasN4.png");
        this.load.image("tilesPlatform", "public/assets/images/atlasN4.png");
      ...
      create() {
        ...
        const tilesetBelow = map.addTilesetImage("atlasN4", "tilesBelow");
